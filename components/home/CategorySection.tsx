...
export default function CategorySection({ data, locale = 'en-us' }: CategorySectionProps) {
  if (!data || data.length === 0) return null;

  const allText = locale === 'ta-in' ? 'அனைத்தும்' : 'All';
          ...
          {data.map((cat: any) => {
            ...
            return (
              <Link 
                ...
                href={`/${locale}/category/${category.uid}`}
              >
